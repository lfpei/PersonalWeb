...
namespace PersonalWeb
{
    public class ValidCode
    {
        ...
        //Image img = Bitmap.FromStream(validCode.CreateCheckCodeImage());
        ...
        { 
            this._len = len; this._codetype = ctype;
        }
        #endregion
        ...
        private System.Drawing.Bitmap TwistImage(Bitmap srcBmp, bool bXDir, double dMultValue, double dPhase)
        {
            ...
            graph.Dispose(); double dBaseAxisLen = bXDir ? (double)destBmp.Height : (double)destBmp.Width; for (int i = 0; i < destBmp.Width; i++)
            {
                for (int j = 0; j < destBmp.Height; j++)
                {
                    ...
                    dx += dPhase; double dy = Math.Sin(dx);// 取得当前点的颜色      
        ...
        public Stream CreateCheckCodeImage()
        {
            ...
            switch (_codetype) 
            { 
                case CodeType.Alphas: checkCode = GenerateAlphas(); break; 
                case CodeType.Numbers: checkCode = GenerateNumbers(); break; 
                case CodeType.Characters: checkCode = GenerateCharacters(); break; 
                default: checkCode = GenerateAlphas(); break; 
            } 
            ...
            try
            {
                ...
                ms = new System.IO.MemoryStream(); image.Save(ms, System.Drawing.Imaging.ImageFormat.Gif);
            }
            finally 
            { 
